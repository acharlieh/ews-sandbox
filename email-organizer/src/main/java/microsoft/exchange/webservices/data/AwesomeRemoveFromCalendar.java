/**************************************************************************
 * copyright file="RemoveFromCalendar.java" company="Microsoft" Copyright (c) Microsoft Corporation. All rights
 * reserved. Defines the RemoveFromCalendar.java.
 **************************************************************************/
...
public class AwesomeRemoveFromCalendar extends ServiceObject {
     ...
     */
    public AwesomeRemoveFromCalendar(final Item referenceItem) throws Exception {
     ...
     */
    @Override
    protected void internalLoad(final PropertySet propertySet) {
     ...
     */
    @Override
    protected void internalDelete(final DeleteMode deleteMode, final SendCancellationsMode sendCancellationsMode,
            final AffectedTaskOccurrence affectedTaskOccurrences) {
        throw new UnsupportedOperationException();
    }
     ...
     * @throws Exception the exception
     */
    public List<Item> internalCreate(final FolderId parentFolderId, final MessageDisposition messageDisposition)
            throws Exception {
        ((ItemId) this.getPropertyBag().getObjectFromPropertyDefinition(ResponseObjectSchema.ReferenceItemId))
